...
class QuizeScreen extends GetView<QuizController> {
  ...
  String Tamamla = 'Tamamla', Ileri = 'Ileri';
      ...
      child: Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            titleWidget: Obx(() => Text(
                  'S. ${(controller.questionIndex.value + 1).toString().padLeft(2, '0')}',
                  style: kAppBarTS,
                )),
          ),
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                             ...
                             Text(
                               Get.locale==const Locale('en','US')?  controller.currentQuestion.value!.questionEn:
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemBuilder:
                                        ...
                                        return AnswerCard(
                                          ...
                                          answer:
                                              '${answer.identifier}. ${Get.locale==const Locale('en','US')?  answer.answerEn:
                                              answer.answer}',
                                        );
                                      },
                                    );
                            ...
                            child: Obx(
                              () => Visibility(
                                ...
                                child: MainButton(
                                  ...
                                  title: controller.islastQuestion ? Tamamla.tr : Ileri.tr,
                                ),
                              ),
                            ),
                          )
