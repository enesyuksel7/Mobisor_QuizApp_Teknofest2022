...
class Resultcreen extends GetView<QuizController> {
  ...
  static String Tebrikler = 'Tebrikler', Toplamda = 'Toplamda', PuanKazandin = 'PuanKazandin', sonucAciklama = 'sonucAciklama', TekrarDene = 'TekrarDene', AnasayfayaDon = 'AnasayfayaDon';
              ...
              Expanded(
                child: ContentArea(
                  ...
                  children: [
                    ...
                    Text(
                      '${Toplamda.tr} ${controller.points} ${PuanKazandin.tr}',
